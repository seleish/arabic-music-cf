...
This has been modified by Safwat Eleish

This is a modified sample application for using simple services on [Cloud Foundry](http://cloudfoundry.org) with the [Spring Framework](http://spring.io) and [Spring Boot](http://projects.spring.io/spring-boot/).
